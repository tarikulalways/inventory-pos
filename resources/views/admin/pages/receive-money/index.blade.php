@extends('master')
@section('title', 'Receive Money List')
@section('content')
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Receive Money List</h4>
                <h6>Manage your Receive Money</h6>
            </div>
            <div class="page-btn">
                <a href="{{ route('create.customerMoney') }}" class="btn btn-added">
                    <img src="assets/img/icons/plus.svg" class="me-1" alt="img">Get Money
                </a>
            </div>
        </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" aria-label="Categoyr_img: activate to sort column ascending"
                                            style="width: 93.5312px;">Receive Money</th>

                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" aria-label="Action: activate to sort column ascending"
                                            style="width: 45.0938px;">created_at</th>
                                ...
                                <tbody>
                                    @foreach ($receiveMoney as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="me-3" href="{{ route('edit.customerMoney', ['customerReceiveMoney'=>$item->id]) }}">
                                                    <img src="assets/img/icons/edit.svg" alt="img">
                                                </a>

                                                <a onclick="return confirm('Are you sure delete data?')" class="me-3" href="{{ route('destroy.customerMoney',  ['customerReceiveMoney'=>$item->id]) }}">
