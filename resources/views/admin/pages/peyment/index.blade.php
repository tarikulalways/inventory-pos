@extends('master')
@section('title', 'Payment Money List')
@section('content')
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Payment Money List</h4>
                <h6>Manage your Payment Money</h6>
            </div>
            <div class="page-btn">
                <a href="{{ route('create.smoney') }}" class="btn btn-added">
                    <img src="assets/img/icons/plus.svg" class="me-1" alt="img">Payment Money
                </a>
            </div>
        </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" aria-label="Categoyr_img: activate to sort column ascending"
                                            style="width: 93.5312px;">Payment Money</th>
                                ...
                                <tbody>
                                    @foreach ($supplierPayment as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['supplierPayment'] }}</td>
                                            <td>{{ $item->created_at->diffForHumans() }}</td>
                                            <td>
                                                <a class="me-3" href="{{ route('edit.smoney', ['supplierPayment'=>$item->id]) }}">
                                                    <img src="assets/img/icons/edit.svg" alt="img">
                                                </a>

                                                <a onclick="return confirm('Are you sure delete data?')" class="me-3" href="{{ route('destroy.smoney', ['supplierPayment'=>$item->id]) }}">
