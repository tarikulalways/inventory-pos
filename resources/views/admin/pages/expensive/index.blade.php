...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('create.expensive') }}" class="btn btn-added">
                            ...
                            <table class="table datanew dataTable no-footer" id="DataTables_Table_0" role="grid"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            style="width: 93.5312px;">Expense for</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" aria-label="Categoyr_img: activate to sort column ascending"
                                ...
                                <tbody>
                                    @foreach ($expensive as $item)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $item['expensfor'] }}</td>
                                            <td>{{ $item['expamount'] }}</td>
                                            <td>
                                                <a class="me-3" href="{{ route('edit.expensive', ['expensive'=>$item->id]) }}">
                                                    <img src="assets/img/icons/edit.svg" alt="img">
                                                </a>

                                                <a onclick="return confirm('Are you sure delete data?')" class="me-3" href="{{ route('destroy.expensive', ['expensive'=>$item->id]) }}">
