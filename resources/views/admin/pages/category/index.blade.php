...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('create.category') }}" class="btn btn-added">
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            style="width: 93.5312px;">Category Name</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" aria-label="Categoyr_img: activate to sort column ascending"
                                            style="width: 93.5312px;">Number of product</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                ...
                                <tbody>
                                    @foreach ($category as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="me-3" href="{{ route('edit.category', ['category'=>$item->id]) }}">
                                                    <img src="assets/img/icons/edit.svg" alt="img">
                                                </a>
                                                <a onclick="return confirm('Are you sure delete data?')" class="me-3" href="{{ route('destroy.category', ['category'=>$item->id]) }}">
